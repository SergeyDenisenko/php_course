...
var_dump((int)'012345'); // приводится к типу integer нольв начале опускается при приведение типа.
...
var_dump((int)0 === (int)'hello, world'); // true; т.к. происходит сравнение по типу с явным приведением к типу integer, так как строка не содержит число, она равно 0
